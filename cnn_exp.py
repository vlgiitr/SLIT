...
class LinearLayer(nn.Linear):
    def __init__(self, in_features, out_features,
        ...
        self.opt = Adam(self.parameters(), lr=0.008) #, lr=0.01
        self.threshold = 2.0
        self.num_epochs = 10
...
class ConvLayer(nn.Module):
    def __init__(
        ...
        self.opt = Adam(self.parameters(), lr=0.006)
        self.threshold = 2.0
        self.num_epochs = 30
...
class MNISTConvNet(nn.Module):
    def __init__(self):
            ...
            # self.conv5 = ConvLayer(64, 64, 3, stride = 5, padding = 0)
            # self.pool2= torch.nn.MaxPool2d(2,2)
            # self.drop2=torch.nn.Dropout(0.25)
            # self.lin1 = LinearLayer(1024, 10)
            
            # self.lin2 = LinearLayer(500, 10)
